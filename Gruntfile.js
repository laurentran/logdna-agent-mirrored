...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        exec: {
            ...
            fpm_rpm: 'fpm -s dir -t rpm -n logdna-agent-linux -v ' + pkg.version + ' --license Commercial --vendor "Answerbook, Inc." --description "LogDNA Agent for Linux" --url http://logdna.com/ -m "<help@logdna.com>" --before-remove ./before-remove --after-upgrade ./after-upgrade -f ./logdna-agent-linux=/usr/bin/logdna-agent-linux ./init-script=/etc/init.d/logdna-agent',
            fpm_deb: 'fpm -s dir -t deb -n logdna-agent-linux -v ' + pkg.version + ' --license Commercial --vendor "Answerbook, Inc." --description "LogDNA Agent for Linux" --url http://logdna.com/ -m "<help@logdna.com>" --before-remove ./before-remove --after-upgrade ./after-upgrade -f --deb-no-default-config-files ./logdna-agent-linux=/usr/bin/logdna-agent-linux ./init-script=/etc/init.d/logdna-agent'
        }
    });
